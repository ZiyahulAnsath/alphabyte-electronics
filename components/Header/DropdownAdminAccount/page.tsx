...
const DropdownAdminAccount = ({ dropdownOpenAdmin, handleAdminLogout }: any) => {
  if (!dropdownOpenAdmin) return null;
  ...
  return (
    <div className="absolute right-10 z-99999 mt-2 flex w-62.5 flex-col rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ">
      ...
      <button
        ...
        onClick={handleAdminLogout} // Call handleLogout function onClick
      >
...
export default DropdownAdminAccount;
