export const footerMenus = [
  {
    ...
    menuList: [
      ...
      { name: "Gallery", routerPath: "/gallery" },
...
export const footerCategories = [
  {
    ...
    menuList: [
      { name: "Lapptop", routerPath: "/" },
      { name: "Storage", routerPath: "/" },
      { name: "Desktops", routerPath: "/" },
      { name: "RAM", routerPath: "/" },
      { name: "Graphics Card", routerPath: "/" },
      { name: "Monitors", routerPath: "/" },
    ],
  },
];
